...
GAMES = [
    ...
    dict(
        ...
        c=dict(
            ...
            es=dict(
                ...
                meta="Juego online gratuito de geometría: perímetro y área de 11 figuras planas, problemas con contexto y retos, con autocorrección inmediata. Para Primaria (5.º-6.º) y primer ciclo de ESO.",
                subject="Geometría", grade="Primaria 5.º - ESO 2.º",
                lead="Figuras, lados, ángulos y propiedades — aprendidos jugando, no memorizando.",
                paragraphs=[
                    "Este juego trabaja el <strong>perímetro y el área</strong> de once figuras planas: cuadrado, rectángulo, triángulo, romboide, rombo, trapecio, pentágono, hexágono, octógono y círculo, más un bloque para identificarlas. Cada figura se dibuja a escala y con las cotas fuera del dibujo, de manera que las medidas siempre se leen bien.",
                    "Hay <strong>cuatro maneras de trabajar cada figura</strong>: practicar el perímetro y el área, hacerlo <strong>al revés</strong> (dada el área, encontrar la medida que falta), resolver <strong>problemas con contexto</strong>, y el <strong>reto</strong> de cinco seguidas sin fallar. Con tres niveles de dificultad, y un botón «¿Cómo se hace?» con la teoría y un ejemplo resuelto antes de responder.",
                ...
                features=[
                    "Perímetro y área de 11 figuras planas, con el dibujo a escala",
                    "4 maneras de trabajarlas: practicar, al revés, problemas y reto",
                    "Tres niveles de dificultad y repaso inteligente",
                    "Teoría con ejemplo resuelto en cada ejercicio",
                    "Reto maestro y reto del día, igual para toda la clase",
            ...
            en=dict(
                ...
                meta="Free online geometry game: perimeter and area of 11 plane shapes, word problems and challenges, with instant correction. For ages 10 to 14.",
                subject="Geometry", grade="Ages 10-14",
                lead="Shapes, sides, angles and properties — learned by playing, not memorising.",
                paragraphs=[
                    "This game works on the <strong>perimeter and area</strong> of eleven plane shapes: square, rectangle, triangle, rhomboid, rhombus, trapezium, pentagon, hexagon, octagon and circle, plus a block for identifying them. Every shape is drawn to scale with the dimensions outside the drawing, so the measurements always read clearly.",
                    "There are <strong>four ways to work on each shape</strong>: practise perimeter and area, do it <strong>backwards</strong> (given the area, find the missing measurement), solve <strong>word problems</strong>, and the <strong>challenge</strong> of five in a row without a mistake. With three difficulty levels, and a \"How do I do it?\" button with the theory and a worked example before answering.",
                ...
                features=[
                    "Perimeter and area of 11 plane shapes, drawn to scale",
                    "4 ways to work on them: practice, backwards, word problems and challenge",
                    "Three difficulty levels and smart revision",
                    "Theory with a worked example in every exercise",
                    "Master challenge and daily challenge, the same for the whole class",
    ...
    dict(
        ...
        level={"ca": "Primària 5è - ESO 2n", "es": "Primaria 5.º - ESO 2.º", "en": "Ages 10-14"},
        c=dict(
            ca=dict(
            ...
            es=dict(
                ...
                meta="Juego online gratuito de ortografía catalana: acentuación, acento diacrítico, apóstrofo, diéresis, g/j, x/ix/tx/ig, plurales, mayúsculas, barbarismos y puntuación — 18 bloques temáticos autocorrectivos.",
                subject="Ortografía", grade="Primaria 5.º - ESO 2.º",
                lead="La ortografía catalana, bloque a bloque y sin miedo al bolígrafo rojo.",
                paragraphs=[
                    "<strong>Dieciocho bloques temáticos</strong> cubren los puntos donde la ortografía catalana duele más: la acentuación y el acento diacrítico, el apóstrofo, la diéresis, la g y la j, la x/ix/tx/ig, la tg/tj/tz, la r y la rr, la ese sorda y la sonora, la ce trencada, la ele geminada, la h muda, la m delante de b y p, los plurales, las mayúsculas, los barbarismos, la coma y el resto de signos de puntuación. Cada bloque se puede trabajar por separado, de manera que el juego se adapta al tema que se esté haciendo en clase.",
                    "Cada bloque tiene <strong>cinco maneras de jugar</strong>: rellenar el hueco, elegir la palabra bien escrita, clasificar, buscar el error dentro de una frase y <strong>dictado</strong> (el juego lee la palabra en voz alta y el alumno la escribe). Y tres niveles de dificultad.",
                ...
                features=[
                    "18 bloques temáticos y más de 500 palabras y frases",
                    "Acentuación, acento diacrítico, apóstrofo, diéresis, g/j, plurales, mayúsculas, barbarismos…",
                    "5 maneras de jugar en cada bloque, dictado incluido",
                    "Tres niveles de dificultad y repaso inteligente",
                    "Cada regla explicada con ejemplos antes y después de responder",
                    "Panel del profesor: qué reglas falla más la clase",
                    "Actividades autocorrectivas y repetibles",
                    "Útil desde final de Primaria hasta la ESO y el aula de acogida",
                    "Gratuito, sin registro y sin anuncios",
                ],
            ),
            en=dict(
                seo_title="Free online Catalan Spelling game",
                meta="Free online Catalan spelling game: accents, diacritics, apostrophes, diaeresis, g/j, plurals, capitals, loanwords and punctuation — 18 self-correcting topic blocks.",
                subject="Spelling", grade="Ages 10-14",
                lead="Catalan spelling, block by block and with no fear of the red pen.",
                paragraphs=[
                    "<strong>Eighteen topic blocks</strong> cover the points where Catalan spelling hurts most: accents and the diacritic accent, the apostrophe, the diaeresis, g and j, x/ix/tx/ig, tg/tj/tz, r and rr, voiced and voiceless s, ç, the geminate l, the silent h, m before b and p, plurals, capital letters, loanwords, the comma and the rest of the punctuation marks. Each block can be practised separately, so the game adapts to whatever is being covered in class.",
                    "Every block has <strong>five ways to play</strong>: fill the gap, pick the correctly spelt word, sort words into groups, find the mistake inside a sentence, and <strong>dictation</strong> (the game reads the word aloud and the student types it). Plus three difficulty levels.",
                ...
                features=[
                    "18 topic blocks and over 500 words and sentences",
                    "Accents, diacritics, apostrophe, diaeresis, g/j, plurals, capitals, loanwords…",
                    "5 ways to play in every block, dictation included",
                    "Three difficulty levels and smart revision",
                    "Every rule explained with examples before and after answering",
                    "Teacher panel: which rules the class gets wrong most",
                    "Self-correcting, repeatable activities",
                    "Useful from late primary through secondary and newcomer classes",
                    "Free, no sign-up, no ads",
                ],
            ),
        ),
